{ stdenv, fetchurl, pkgconfig, gnused_422, perl, python2, zip, libffi, readline, icu, zlib, nspr, darwin }:
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ libffi readline icu zlib nspr ]
                ++ stdenv.lib.optional stdenv.isDarwin [ darwin.apple_sdk.frameworks.IOKit darwin.libobjc ];
